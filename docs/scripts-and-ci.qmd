...
This documentation site itself (`docs/`) is a separate, nested Quarto website project (its own `docs/_quarto.yml`) and is published to GitHub Pages by its own workflow, independent of the two jobs above.
